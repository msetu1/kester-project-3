        ...
        <div className="w-full lg:w-[60%] ">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="	https://themewant.com/products/wordpress/kester/wp-content/uploads/2023/06/blog-8.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="	https://themewant.com/products/wordpress/kester/wp-content/uploads/2023/06/blog.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="	https://themewant.com/products/wordpress/kester/wp-content/uploads/2023/06/blog-7.jpg"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
          ...
          <div className="mb-10 lg:mx-0 mx-4">
            <div className="card bg-base-100 shadow-xl border">
              <figure>
                <img
                  src="	https://themewant.com/products/wordpress/kester/wp-content/uploads/2023/06/blog-3.webp"
                  alt="Shoes"
                />
              </figure>
              <div className="card-body">
